...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'press_author', 'position',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Author.about'
        db.alter_column(u'press_author', 'about', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Author.position'
        db.delete_column(u'press_author', 'position')


        # Changing field 'Author.about'
        db.alter_column(u'press_author', 'about', self.gf('django.db.models.fields.TextField')(default=''))
