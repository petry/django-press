...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.new_author'
        db.add_column(u'press_article', 'new_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='authors', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.new_author'
        db.delete_column(u'press_article', 'new_author_id')
