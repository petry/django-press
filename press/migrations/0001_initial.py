...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'press_article', (
            ...
            ('public', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft', unique=True, null=True, to=orm['press.Article'])),
            ...
            ('crated_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        u'press.article': {
            ...
            'crated_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
