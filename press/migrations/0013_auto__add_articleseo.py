...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleSeo'
        db.create_table(u'press_articleseo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('publish_state', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('public', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft', unique=True, null=True, to=orm['press.ArticleSeo'])),
            ('article', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['press.Article'], unique=True)),
        ...
        db.send_create_signal(u'press', ['ArticleSeo'])


    def backwards(self, orm):
        # Deleting model 'ArticleSeo'
        db.delete_table(u'press_articleseo')
    ...
    models = {
        ...
        u'press.article': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'authors'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'press.articleseo': {
            'Meta': {'object_name': 'ArticleSeo'},
            'article': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['press.Article']", 'unique': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'keywords': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'public': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft'", 'unique': 'True', 'null': 'True', 'to': u"orm['press.ArticleSeo']"}),
            'publish_state': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'})
        },
        u'press.section': {
