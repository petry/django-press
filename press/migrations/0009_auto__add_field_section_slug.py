...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'press_section', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='nosection', max_length=100, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.slug'
        db.delete_column(u'press_section', 'slug')
